...
// Command     : write_verilog -force -mode synth_stub -rename_top soc_rtos_can_axi_timer_0_1 -prefix
//               soc_rtos_can_axi_timer_0_1_ soc_rtos_can_axi_timer_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "soc_rtos_can_axi_timer_0_0,axi_timer,{}" *) (* core_generation_info = "soc_rtos_can_axi_timer_0_0,axi_timer,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_timer,x_ipVersion=2.0,x_ipCoreRevision=35,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=artix7,C_COUNT_WIDTH=32,C_ONE_TIMER_ONLY=0,C_TRIG0_ASSERT=1,C_TRIG1_ASSERT=1,C_GEN0_ASSERT=1,C_GEN1_ASSERT=1,C_S_AXI_DATA_WIDTH=32,C_S_AXI_ADDR_WIDTH=5}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_timer,Vivado 2024.2" *) 
module soc_rtos_can_axi_timer_0_1(capturetrig0, capturetrig1, generateout0, 
