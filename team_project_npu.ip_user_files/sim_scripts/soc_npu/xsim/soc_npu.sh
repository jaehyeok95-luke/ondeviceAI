...
export RDI_DATADIR="/home/jaehyeok95/Xilinx/Vivado/2024.2/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jaehyeok95/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_npu.wdb xsim.dir libdpi.so)
