...
/* Definitions for peripheral MYIP_IIC_CNTR_0 */
#define XPAR_MYIP_IIC_CNTR_0_BASEADDR 0x44a30000
#define XPAR_MYIP_IIC_CNTR_0_HIGHADDR 0x44a3ffff

/* Canonical definitions for peripheral MYIP_IIC_CNTR_0 */
#define XPAR_MYIP_IIC_CNTR_0_BASEADDR 0x44a30000
#define XPAR_MYIP_IIC_CNTR_0_HIGHADDR 0x44a3ffff

/* Definitions for peripheral MYIP_KOREAWATCH_0 */
#define XPAR_MYIP_KOREAWATCH_0_BASEADDR 0x44a00000
#define XPAR_MYIP_KOREAWATCH_0_HIGHADDR 0x44a0ffff

/* Canonical definitions for peripheral MYIP_KOREAWATCH_0 */
#define XPAR_MYIP_KOREAWATCH_0_BASEADDR 0x44a00000
#define XPAR_MYIP_KOREAWATCH_0_HIGHADDR 0x44a0ffff

/* Definitions for peripheral MYIP_STOPWATCH_0 */
#define XPAR_MYIP_STOPWATCH_0_BASEADDR 0x44a10000
#define XPAR_MYIP_STOPWATCH_0_HIGHADDR 0x44a1ffff

/* Canonical definitions for peripheral MYIP_STOPWATCH_0 */
#define XPAR_MYIP_STOPWATCH_0_BASEADDR 0x44a10000
#define XPAR_MYIP_STOPWATCH_0_HIGHADDR 0x44a1ffff

/* Definitions for peripheral MYIP_TIMER_0 */
#define XPAR_MYIP_TIMER_0_BASEADDR 0x44a20000
#define XPAR_MYIP_TIMER_0_HIGHADDR 0x44a2ffff

/* Canonical definitions for peripheral MYIP_TIMER_0 */
#define XPAR_MYIP_TIMER_0_BASEADDR 0x44a20000
#define XPAR_MYIP_TIMER_0_HIGHADDR 0x44a2ffff
