...
#
# Script generated by Vivado on Sun Feb 01 11:42:07 KST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : soc_watchRev2.sh
...
#
# Usage        : soc_watchRev2.sh
#                soc_watchRev2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                soc_watchRev2.sh [-reset_run]
#                soc_watchRev2.sh [-reset_log]
#                soc_watchRev2.sh [-help]
#
...
#                script (type 'soc_watchRev2.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_16 -libname xil_defaultlib -libname microblaze_v11_0_14 -libname microblaze_riscv_v1_0_3 -libname lmb_v10_v3_0_14 -libname lmb_bram_if_cntlr_v4_0_25 -libname blk_mem_gen_v8_4_9 -libname generic_baseblocks_v2_1_2 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_33 -libname fifo_generator_v13_2_11 -libname axi_data_fifo_v2_1_32 -libname axi_crossbar_v2_1_34 -libname axi_lite_ipif_v3_0_4 -libname axi_intc_v4_1_20 -libname xlconcat_v2_1_6 -libname mdm_riscv_v1_0_3 -libname lib_pkg_v1_0_4 -libname lib_srl_fifo_v1_0_4 -libname axi_uartlite_v2_0_37 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_35 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 xil_defaultlib microblaze_v11_0_14 microblaze_riscv_v1_0_3 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_25 blk_mem_gen_v8_4_9 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 axi_lite_ipif_v3_0_4 axi_intc_v4_1_20 xlconcat_v2_1_6 mdm_riscv_v1_0_3 lib_pkg_v1_0_4 lib_srl_fifo_v1_0_4 axi_uartlite_v2_0_37 interrupt_control_v3_1_5 axi_gpio_v2_0_35)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "soc_watchRev2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./soc_watchRev2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_11 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_32 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/65ce/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_34 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconcat_v2_1_6 $xmvlog_opts +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.soc_watchRev2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.soc_watchRev2 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/user14/data/work/SOC_exam_2026/SOC_exam_2026.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log soc_watchRev2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./soc_watchRev2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: soc_watchRev2.sh [-help]\n\
Usage: soc_watchRev2.sh [-step]\n\
Usage: soc_watchRev2.sh [-lib_map_path]\n\
Usage: soc_watchRev2.sh [-reset_run]\n\
Usage: soc_watchRev2.sh [-reset_log]\n\
Usage: soc_watchRev2.sh [-keep_index]\n\
Usage: soc_watchRev2.sh [-noclean_files]\n\n\
