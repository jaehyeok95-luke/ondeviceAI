...
export RDI_DATADIR="/media/user14/data/tools/xilinx/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L microblaze_v11_0_14 -L microblaze_riscv_v1_0_3 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_20 -L xlconcat_v2_1_6 -L mdm_riscv_v1_0_3 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_37 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot soc_watchRev2 xil_defaultlib.soc_watchRev2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim soc_watchRev2 -key {Behavioral:sim_1:Functional:soc_watchRev2} -tclbatch cmd.tcl -protoinst "protoinst_files/soc_watchRev2.protoinst" -protoinst "protoinst_files/soc_INT.protoinst" -protoinst "protoinst_files/soc_test.protoinst" -protoinst "protoinst_files/bd_2ebe.protoinst" -protoinst "protoinst_files/soc_cooktimer.protoinst" -protoinst "protoinst_files/bd_b44e.protoinst" -protoinst "protoinst_files/soc_iic_dht11.protoinst" -protoinst "protoinst_files/bd_d10c.protoinst" -protoinst "protoinst_files/bd_050e.protoinst" -protoinst "protoinst_files/soc_fnd_cntr.protoinst" -protoinst "protoinst_files/bd_6480.protoinst" -protoinst "protoinst_files/soc_iic.protoinst" -protoinst "protoinst_files/bd_bddd.protoinst" -protoinst "protoinst_files/bd_d47b.protoinst" -protoinst "protoinst_files/soc_fnd.protoinst" -protoinst "protoinst_files/bd_d8be.protoinst" -protoinst "protoinst_files/soc_gpio.protoinst" -protoinst "protoinst_files/bd_57e4.protoinst" -protoinst "protoinst_files/soc_hello.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/user14/data/tools/xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_watchRev2.wdb xsim.dir libdpi.so)
