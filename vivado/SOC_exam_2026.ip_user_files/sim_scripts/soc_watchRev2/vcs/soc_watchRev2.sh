...
design_libs=(xilinx_vip xpm lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 xil_defaultlib microblaze_v11_0_14 microblaze_riscv_v1_0_3 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_25 blk_mem_gen_v8_4_9 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 axi_lite_ipif_v3_0_4 axi_intc_v4_1_20 xlconcat_v2_1_6 mdm_riscv_v1_0_3 lib_pkg_v1_0_4 lib_srl_fifo_v1_0_4 axi_uartlite_v2_0_37 interrupt_control_v3_1_5 axi_gpio_v2_0_35)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_9 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_33 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_11 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/65ce/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_34 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xlconcat_v2_1_6 $vlogan_opts +v2k +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/3cbc" +incdir+"../../../../SOC_exam_2026.gen/sources_1/bd/soc_watchRev2/ipshared/ec67/hdl" +incdir+"/media/user14/data/tools/xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.soc_watchRev2 xil_defaultlib.glbl -o soc_watchRev2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./soc_watchRev2_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/user14/data/work/SOC_exam_2026/SOC_exam_2026.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key soc_watchRev2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc soc_watchRev2_simv.daidir vcs_lib c.obj)
