...
//Command     : generate_target soc_hello.bd
//Design      : soc_hello
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module microblaze_riscv_0_local_memory_imp_KZWAQ9
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > soc_hello microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_hello_dlmb_bram_if_cntlr_1 dlmb_bram_if_cntlr
  ...
  soc_hello_dlmb_v10_1 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  soc_hello_ilmb_bram_if_cntlr_1 ilmb_bram_if_cntlr
...
(* CORE_GENERATION_INFO = "soc_hello,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_hello,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=4,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "soc_hello.hwdef" *) 
module soc_hello
   (reset,
    sys_clock,
    usb_uart_rxd,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN soc_hello_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  soc_hello_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
        ...
        .tx(usb_uart_txd));
  soc_hello_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  soc_hello_mdm_1_1 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > soc_hello microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_hello_microblaze_riscv_0_2 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_KZWAQ9 microblaze_riscv_0_local_memory
  ...
  soc_hello_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
