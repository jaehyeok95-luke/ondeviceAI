...
module soc_fnd (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN soc_fnd_sys_clock, INSERT_VIP 0" *)
  input sys_clock;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 seven_seg_led_disp TRI_O" *)
  (* X_INTERFACE_MODE = "master seven_seg_led_disp" *)
