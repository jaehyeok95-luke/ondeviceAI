...
//               /media/user14/data/work/SOC_exam_2026/SOC_exam_2026.gen/sources_1/bd/soc_INT/ip/soc_INT_microblaze_riscv_0_axi_intc_1/soc_INT_microblaze_riscv_0_axi_intc_1_stub.v
...
(* CHECK_LICENSE_TYPE = "soc_INT_microblaze_riscv_0_axi_intc_1,axi_intc,{}" *) (* core_generation_info = "soc_INT_microblaze_riscv_0_axi_intc_1,axi_intc,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_intc,x_ipVersion=4.1,x_ipCoreRevision=20,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=artix7,C_INSTANCE=soc_INT_microblaze_riscv_0_axi_intc_1,C_S_AXI_ADDR_WIDTH=9,C_S_AXI_DATA_WIDTH=32,C_NUM_INTR_INPUTS=2,C_NUM_SW_INTR=0,C_KIND_OF_INTR=0xfffffffd,C_KIND_OF_EDGE=0xFFFFFFFF,C_KIND_OF_LVL=0xFFFFFFFF,C_ASYNC_INTR=0xFFFFFFFC,C_NUM_SYNC_FF=2,C_ADDR_WIDTH=32,C_IVAR_RESET_VALUE=0x0000000000000010,C_ENABLE_ASYNC=0,C_HAS_IPR=1,C_HAS_SIE=1,C_HAS_CIE=1,C_HAS_IVR=1,C_HAS_ILR=0,C_IRQ_IS_LEVEL=1,C_IRQ_ACTIVE=0x1,C_DISABLE_SYNCHRONIZERS=1,C_MB_CLK_NOT_CONNECTED=1,C_HAS_FAST=1,C_EN_CASCADE_MODE=0,C_CASCADE_MASTER=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_intc,Vivado 2024.2" *) 
module soc_INT_microblaze_riscv_0_axi_intc_1(s_axi_aclk, s_axi_aresetn, s_axi_awaddr, 
