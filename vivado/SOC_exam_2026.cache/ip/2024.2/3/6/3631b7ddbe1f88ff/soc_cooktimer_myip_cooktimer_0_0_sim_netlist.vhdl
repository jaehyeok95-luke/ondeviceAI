...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_p is
  ...
  attribute SOFT_HLUTNM of alarm_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \sec[7]_i_1\ : label is "soft_lutpair0";
begin
alarm_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cook_timer_ip is
  ...
  signal alarm_i_6_n_0 : STD_LOGIC;
  ...
  signal ed_alarmOff_n_3 : STD_LOGIC;
  signal ed_dcnt_n_0 : STD_LOGIC;
  signal ed_dcnt_n_1 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of alarm_i_3 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \sec[6]_i_2\ : label is "soft_lutpair1";
begin
  SR(0) <= \^sr\(0);
...
alarm_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
ed_alarmOff: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_n
     port map (
      Q(0) => Q(1),
...
ed_dcnt: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_p
     port map (
      CO(0) => \cnt_sysclk1_carry__2_n_1\,
      E(0) => ed_dcnt_n_0,
      Q(0) => Q(0),
      dcnt_set2_out => dcnt_set2_out,
      dcnt_set_reg(0) => ed_dcnt_n_1,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myip_cooktimer_slave_lite_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state_write[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FSM_sequential_state_write[1]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \slv_reg0[31]_i_4\ : label is "soft_lutpair4";
begin
