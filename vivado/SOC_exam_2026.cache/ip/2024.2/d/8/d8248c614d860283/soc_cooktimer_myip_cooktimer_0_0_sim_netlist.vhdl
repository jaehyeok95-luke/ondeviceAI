...
alarm_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cook_timer_ip is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of alarm_i_4 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of alarm_i_5 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \sec[7]_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \sec[7]_i_6\ : label is "soft_lutpair2";
begin
  SR(0) <= \^sr\(0);
