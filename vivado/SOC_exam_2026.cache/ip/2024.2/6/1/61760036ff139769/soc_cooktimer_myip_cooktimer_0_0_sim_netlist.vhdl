...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cook_timer_ip is
  ...
  signal \sec[2]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \sec[2]_i_2\ : label is "soft_lutpair3";
...
\cnt_sysclk[0]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\sec[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
